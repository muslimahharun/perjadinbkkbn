                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                ...
                                <li><a data-toggle="collapse" data-target="#demo" href="#">Dokumen</a>
                                    <ul id="demo" class="collapse dropdown-header-top">
                                        <li><a href="<?= base_url('C_Foto') ?>">Foto</a></li>
                                        <li><a href="form-components.html">File</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </nav>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wizard-wrap-int">
                        <div class="wizard-hd">
                            <center><h2>Edit Perjalanan Dinas</h2></center>
                        </div>
                        <div id="rootwizard">
                            <div class="navbar">
							...
							<section>
								<div class="row">
									<div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="tanggal_surat" class="form-control" value="<?= $res[0]['tanggal_surat'] ?>">
										</div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
										<div class="form-group">
											...
											<textarea class="form-control" name="judul_kegiatan"><?= $res[0]['judul_kegiatan'] ?></textarea>
										</div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="tanggal_berangkat" class="form-control" value="<?= $res[0]['tanggal_berangkat'] ?>">
										</div>
                                        <div class="form-group">
											<label for="staticEmail" class=" col-form-label">Lama (hari)</label>
                                            <input type="number" name="lama" class="form-control" value="<?= $res[0]['lama'] ?>">
										</div>
                                    </div>
								</div>
							    </section>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="pejabat_persetujuan">
                                                    <?php foreach($pegawai as $kd): ?>
                                                    <option
                                                    <?php if($res[0]['pejabat_persetujuan'] == $kd['nama']){echo 'selected';} ?>
                                                    value="<?= $kd['nama'] . ' / '.$kd['username'] . ' / '.$kd['jabatan']?>">
                                                    <?= $kd['nama'] . ' / '.$kd['username'] . ' / '.$kd['jabatan'] ?>
                                                    </option>
                                                    <?php endforeach; ?>
                                            ...
                                            <div class="form-group">
                                                <label for="">Pejabat Pembuat Komitmen</label>
                                                    ...
                                                    <?php foreach($pegawai as $kd): ?>
                                                    <option
                                                    <?php if($res[0]['pejabat_komitmen'] == $kd['nama']){echo 'selected';} ?>
                                                    value="<?= $kd['nama'] . ' / '.$kd['username'] . ' / '.$kd['jabatan']?>">
                                                    <?= $kd['nama'] . ' / '.$kd['username'] . ' / '.$kd['jabatan'] ?>
                                                    </option>
                                                    <?php endforeach; ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="bendahara">
                                                    <?php foreach($pegawai as $kd): ?>
                                                   <option <?php if($res[0]['bendahara'] == $kd['nama']){echo 'selected';} ?>
                                                    value="<?= $kd['nama'] . ' / '.$kd['username'] . ' / '.$kd['jabatan']?>">
                                                    <?= $kd['nama'] . ' / '.$kd['username'] . ' / '.$kd['jabatan'] ?>
                                                    </option>
                                                    <?php endforeach; ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="menimbang" class="form-control" id="" rows="5"><?= $res[0]['menimbang'] ?></textarea>
                                            </div>
                                        </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="">Dasar</label>
                                                    <textarea name="dasar" class="form-control" id="" rows="5"><?= $res[0]['dasar'] ?></textarea>
                                                </div>
                                            </div> 
                                        </div>
                                    </div>
                                <div class="tab-pane wizard-ctn" id="tab4">
                                    <div class="row">
                                        <div class="col-md-12">
                                        <div class="form-group">
                                        <label class="control-label">Upload Laporan</label>
                                ...
                                <div class="tab-pane wizard-ctn" id="tab5">
                                    <div class="row">
                                        ...
                                        <div class="dropzone-wrapper">
                                            ...
                                            <input type="file" name="foto[]" multiple class="dropzone" rows="5">
                                        </div>
                                        </div>
                                        </div>
                                        </div>
                                ...
                                <div class="tab-pane wizard-ctn" id="tab6">
                                            <div class="dialog-inner mg-t-30">
                                                ...
                                                <div class="dialog-pro dialog">
                                                    <center><button class="btn btn-info" id="sa-params">Submit</button></center>
                                                </div>
                                            </div>
                                        </div>
                                </div>
