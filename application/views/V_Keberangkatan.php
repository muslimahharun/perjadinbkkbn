                                        ...
                                        <td>
                                          <div class="btn-group notika-tl-btn">
                                            <button type="button" class="btn btn-primary notika-gp-primary btn-xs" data-toggle="modal"
                                              ...
                                              <a target="_blank" href="<?= base_url('C_Keberangkatan/destroy/').$data['id'] ?>" class="btn btn-primary notika-gp-primary btn-xs"
                                    ...
                                    <div class="modal-dialog modals-default">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <center><h2>Edit Data Keberangkatan</h2></center>
                                                <form action="<?= base_url('C_Keberangkatan/update/').$data['id'] ?>" method="post">
                                                <div class="modal-body">
    ...
    <div class="modal fade" id="addModal" role="dialog">
        <div class="modal-dialog modals-default">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <center><h2>Tambah Data Keberangkatan</h2></center>
              <form action="<?= base_url('C_Keberangkatan/store/').$data['id'] ?>" method="post">
                <div class="modal-body">
                  <div class="form-group">
