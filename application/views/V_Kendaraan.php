                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary notika-gp-primary btn-xs" data-toggle="modal"
                                              ...
                                              <a target="_blank" href="<?= base_url('C_Kendaraan/destroy/').$data['id'] ?>" class="btn btn-primary notika-gp-primary btn-xs"
                                    ...
                                    <div class="modal-dialog modals-default">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <center><h2>Edit Data Kendaraan</h2></center>
                                                <form action="<?= base_url('C_Kendaraan/update/').$data['id'] ?>" method="post">
                                                <div class="modal-body">
    ...
    <div class="modal fade" id="addModal" role="dialog">
        <div class="modal-dialog modals-default">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <center><h2>Tambah Data Kendaraan</h2></center>
              <form action="<?= base_url('C_Kendaraan/store/').$data['id'] ?>" method="post">
                <div class="modal-body">
                  <div class="form-group">
