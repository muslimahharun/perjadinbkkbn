                                        ...
                                        <td>
                                          <div class="btn-group notika-tl-btn">
                                            <button type="button" class="btn btn-primary notika-gp-primary btn-xs" data-toggle="modal"
                                              ...
                                              <a target="_blank" href="<?= base_url('C_Dipa/destroy/').$data['id'] ?>" class="btn btn-primary notika-gp-primary btn-xs"
                                    ...
                                    <div class="modal-dialog modals-default">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <center><h2>Edit Data DIPA</h2></center>
    ...
    <div class="modal fade" id="addModal" role="dialog">
        <div class="modal-dialog modals-default">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <center><h2>Tambah Data DIPA</h2></center>
              <form action="<?= base_url('C_Dipa/store/').$data['id'] ?>" method="post">
                <div class="modal-body">
                  <div class="form-group">
                    <label for="">Tahun</label>
                    <input type="number" class="form-control" name="tahun">
