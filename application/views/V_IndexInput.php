                    ...
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
							...
							<div class="breadcomb-report">
								<a href="<?= base_url('C_Input/input') ?>" data-placement="left" class="btn">Tambah Data<a>
							</div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="modals-default-cl">
                                                ...
                                                data-target="#myModalone<?= $data['id_perjalanan'] ?>">Detail</button>
                                                        <a href="<?= base_url('C_Input/edit/').$data['id_perjalanan'] ?>" class="btn btn-primary notika-gp-primary btn-xs">Edit</a>
                                                        <a href="<?= base_url('C_Input/destroy/').$data['id_perjalanan'] ?>" class="btn btn-primary notika-gp-primary btn-xs"
